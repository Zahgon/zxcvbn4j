...
public class Scoring {
    ...
    public Strength mostGuessableMatchSequence(CharSequence password, List<Match> matches, boolean excludeAdditive) {
        MatchSequence matchSequence = calculateMostGuessableMatchSequence(password, matches, excludeAdditive);
     ...
     */
    public MatchSequence calculateMostGuessableMatchSequence(CharSequence password, List<Match> matches) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @return A MatchSequence containing the most guessable sequence and associated guesses.
     */
    public MatchSequence calculateMostGuessableMatchSequence(CharSequence password, List<Match> matches, boolean excludeAdditive) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
    ...
    private static Optimal computeOptimal(Context context, CharSequence password, List<List<Match>> matchesByEndPosition, boolean excludeAdditive) {
    ...
    private static void updateOptimal(Context context, CharSequence password, Match match, int l, Optimal optimal, boolean excludeAdditive) {
    ...
    private static double calculateGuesses(Context context, CharSequence password, Match match, int l, Optimal optimal) {
    ...
    private static void updateBruteforceMatches(Context context, CharSequence password, int endIndex, Optimal optimal, boolean excludeAdditive) {
