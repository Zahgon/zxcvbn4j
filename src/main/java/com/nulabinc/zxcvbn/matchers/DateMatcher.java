...
public class DateMatcher extends BaseMatcher {
    ...
    private static final Pattern MAYBE_DATE_WITH_SEPARATOR = Pattern.compile("^" + // day, month, year
    "(\\d{1,4})" + // separator
    "([\\s/\\\\_.-])" + // day, month
    ...
    static {
        DATE_SPLITS[4] = // for length-4 strings, e.g. 1191 or 9111, two ways to split:
        new int[][] { // 1 1 91 (2nd split starts at index 1, 3rd at index 2)
        new int[] { 1, 2 }, // 91 1 1
        new int[] { 2, 3 } };
        DATE_SPLITS[5] = new int[][] { // 1 11 91
        new int[] { 1, 3 }, // 11 1 91
        new int[] { 2, 3 } };
        DATE_SPLITS[6] = new int[][] { // 1 1 1991
        new int[] { 1, 2 }, // 11 11 91
        new int[] { 2, 4 }, // 1991 1 1
        new int[] { 4, 5 } };
        DATE_SPLITS[7] = new int[][] { // 1 11 1991
        new int[] { 1, 3 }, // 11 1 1991
        new int[] { 2, 3 }, // 1991 1 11
        new int[] { 4, 5 }, // 1991 11 1
        new int[] { 4, 6 } };
        DATE_SPLITS[8] = new int[][] { // 11 11 1991
        new int[] { 2, 4 }, // 1991 11 11
        new int[] { 4, 6 } };
    }
    ...
    private static int[][] getPossibleYearSplits(int[] ints) {
        ...
        return new int[][] { // year last
        { ints[2], ints[0], ints[1] }, // year first
