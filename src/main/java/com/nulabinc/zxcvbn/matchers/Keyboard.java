...
public class Keyboard {
    ...
    public abstract static class AdjacentGraphBuilder {
        ...
        /**
         * builds an adjacency graph as a dictionary: {character: [adjacent_characters]}. adjacent
         * characters occur in a clockwise order. for example: on qwerty layout, 'g' maps to ['fF',
         * 'tT', 'yY', 'hH', 'bB', 'vV'] on keypad layout, '7' maps to [None, None, None, '=', '8', '5',
         * '4', None] *
         */
