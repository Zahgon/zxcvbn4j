...
public class StandardDictionaries {
    ...
    public static final DictionaryLoader US_TV_AND_FILM_LOADER = new DictionaryLoader(US_TV_AND_FILM, new ClasspathResource(BASE_PATH + "us_tv_and_film.txt"));
    ...
    public static final DictionaryLoader PASSWORDS_LOADER = new DictionaryLoader(PASSWORDS, new ClasspathResource(BASE_PATH + "passwords.txt"));

    public static final DictionaryLoader SURNAMES_LOADER = new DictionaryLoader(SURNAMES, new ClasspathResource(BASE_PATH + "surnames.txt"));

    public static final DictionaryLoader MALE_NAMES_LOADER = new DictionaryLoader(MALE_NAMES, new ClasspathResource(BASE_PATH + "male_names.txt"));

    public static final DictionaryLoader FEMALE_NAMES_LOADER = new DictionaryLoader(FEMALE_NAMES, new ClasspathResource(BASE_PATH + "female_names.txt"));

    private StandardDictionaries() {
        throw new IllegalStateException("StandardDictionaries should not be instantiated");
    }

    private static final DictionaryLoader[] ALL_LOADERS = { US_TV_AND_FILM_LOADER, ENGLISH_WIKIPEDIA_LOADER, PASSWORDS_LOADER, SURNAMES_LOADER, MALE_NAMES_LOADER, FEMALE_NAMES_LOADER };
